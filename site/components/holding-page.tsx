...
const SEQUENCES: Step[][] = [
  [
    ...
    { id: "t2", line: "l2", text: "Loading content engine...", delay: 800 },
    { id: "t3", line: "l3", text: "✓ 3 meta-skills committed", delay: 1600 },
    { id: "t4", line: "l4", text: "✓ Brand system live", delay: 2200 },
    {
      id: "t5",
      line: "l5",
      text: "Building in public. Read the repo.",
      delay: 3000,
    },
  ],
  [
    { id: "t1", text: 'skill read --id="CON-001"', delay: 0 },
    {
      id: "t2",
      line: "l2",
      text: "Loading: content/write-build-log.md",
      delay: 900,
    },
    { id: "t3", line: "l3", text: "✓ v1.0 committed", delay: 1800 },
    {
      id: "t4",
      line: "l4",
      text: "✓ Pending first end-to-end run",
      delay: 2500,
    },
    {
      id: "t5",
      line: "l5",
      text: "Real prompts. Real outputs. No mocks.",
      delay: 3200,
    },
  ],
  [
    { id: "t1", text: 'log fetch --entry="000"', delay: 0 },
    {
      id: "t2",
      line: "l2",
      text: "Loading: build-log/000-planning...",
      delay: 800,
    },
    {
      id: "t3",
      line: "l3",
      text: "✓ May 2026 — content workflow",
      delay: 1600,
    },
    { id: "t4", line: "l4", text: "✓ Backlog: 10 items, 4 done", delay: 2400 },
    {
      id: "t5",
      line: "l5",
      text: "Watch the work, line by line.",
      delay: 3200,
    },
  ],
];
